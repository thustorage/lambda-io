...
// yz add
static void (*bpf_memcpy)(void *dst, const void *src, size_t len) = (void *) 156;
static void *(*bpf_malloc)(size_t size) = (void *) 157;
static void (*bpf_free)(void *pt) = (void *)158;
static void (*bpf_mem_read)(void *dst, void *src, __s64 offset, size_t size, size_t boundary) = (void *)159;
static void (*bpf_mem_write)(void *dst, void *src, __s64 offset, size_t size, size_t boundary) = (void *)160;
static int (*bpf_memcmp)(const void *dst, const void *src, size_t len) = (void *) 161;
static void * (*bpf_memset)(void *dst, int ch, size_t len) = (void *) 162;
